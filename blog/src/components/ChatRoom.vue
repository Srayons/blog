  ...
  <div>
    ...
    >
      ...
      <div id="message" class="message">
        ...
        >
          <!-- 头像 -->
          <img v-if="item.avatar" :class="isleft(item)" :src="item.avatar"/>
          <svg
              v-if="item.nickname === '智能蜡笔小❤'"
              :class="isleft(item)"
              aria-hidden="true"
              height="1em"
              viewBox="0 0 32 32"
  ...
  data: function() {
    return {
      ...
      socketMsg: {
        ...
        userId: null,
        type: 3,
        ipAddress: "chat-gpt-plus",
        ipSource: "chat-gpt-plus"
      }
    };
  },
  methods: {
